...
class AlbumSmartphone extends StatelessWidget {
  const AlbumSmartphone({super.key});
    ...
    return Scaffold(
      ...
      body: CustomScrollView(
        slivers: [
          ...
          AlbumSharedWidgets.buildSliverTrackList(context, hideTime: true, hideArtist: true),
        ],
      ),
    );
  }
