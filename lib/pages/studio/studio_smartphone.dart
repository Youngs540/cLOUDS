...
class StudioSmartphone extends StatelessWidget {
  const StudioSmartphone({super.key});
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          // Stack stat cards vertically for smartphone
          Column(
            children: [
          ...
          StudioSharedWidgets.buildGrowthSection(context, stacked: true),
          const SizedBox(height: 40),
          Text(
            "Recent Activities",
          ...
          const SizedBox(height: 24),
          StudioSharedWidgets.buildProfileEditor(context, stacked: true),
