          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text("$artisteName • $genre", 
                  style: const TextStyle(color: AppTheme.textSecondary, fontSize: 12)),
                const SizedBox(height: 12),
                Row(
                  children: const [
                    Icon(Icons.play_circle_outline, color: AppTheme.newPurple, size: 20),
                    SizedBox(width: 4),
                    Text("PLAY NOW", 
                      style: TextStyle(color: AppTheme.newPurple, fontSize: 10, fontWeight: FontWeight.bold)),
                  ],
                ),
              ],
            ),
